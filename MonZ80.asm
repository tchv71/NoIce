...
IFDEF MSX
ROM_START	equ 07100h;			; START OF MONITOR CODE
ELSE
ROM_START	equ 0b100h;0C800h		; START OF MONITOR CODE
ENDIF
RAM_START	equ ROM_START+480h		; 0d310h		;START OF MONITOR RAM
USER_CODE	equ ROM_START-100h		; RST 1 handler
?CTRL	equ	40h
?SHIFT	equ	20h
...
IFDEF	MSX
FT245R  equ	0FFF8h; 094h	;  base address of FT245R FIFO
ELSE
...
ifdef MSX
VRAM_ADR::	DW 0		; VRAM buffer visible start address - 0B7C2h
PPI_ADR::	DW 0A8h 	; VV55 keyboard Controller - 0C200h
PPI2_ADR::	DW 0		; VV55 additional PPI  - 0C400h
DISP_ADR::	DW 0		; VG75 Display Controller - 0C000h
DMA_ADR::	DW 0		; VT57 DMA Controller - 0C600h;0E000h
...
DMA_ADR::	DW 0C600h	; VT57 DMA Controller - 0C600h;0E000h
